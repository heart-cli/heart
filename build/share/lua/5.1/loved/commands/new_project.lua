...
local function mkdir(...)
    ...
    logger.debug('Create folder %s', path_folder)
...
local function extract_love(path_temp, filename, path_loved)
    ...
    logger.debug()
    logger.debug('Extracting %s', path_zipped)
    ...
    logger.debug('Installing %s', path_unzipped)
...
local function move_love(path_temp, filename, path_loved)
    ...
    logger.debug()
    logger.debug('Moving %s to %s', path_exe_temp, path_love)
